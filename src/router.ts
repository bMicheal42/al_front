  ...
  const router = new VueRouter({
    ...
    routes: [
      ...
      },
      {
        path: '/patterns',
        name: 'patterns',
        component: () => import(/* webpackChunkName: 'user' */ './views/Patterns.vue'),
        meta: {title: 'Patterns', requiresAuth: true}
      },
      {
        path: '/analytics',
        name: 'analytics',
        component: () => import(/* webpackChunkName: 'user' */ './views/Analytics.vue'),
