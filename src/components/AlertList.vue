...
export default {
  ...
  data: vm => ({
    ...
    headersMap: {
      ...
      environment: {text: i18n.t('Environment'), sortable: false,value: 'environment'},
      severity: {text: i18n.t('Severity'), sortable: false, value: 'severity'},
      correlate: {text: i18n.t('Correlate'), sortable: false, value: 'correlate'},
      ...
      dutyadmin: {text: i18n.t('Dutyadmin'), value: 'dutyadmin', class: 'text-no-wrap',sortable: false},
      duplicateCount: {text: i18n.t('Dupl'), value: 'duplicateCount',sortable: false},
      repeat: {text: i18n.t('Repeat'), value: 'repeat',sortable: false},
      patterns: {text: i18n.t('Patterns'), value: 'patterns', sortable: false},
      previousSeverity: {text: i18n.t('PrevSeverity'), value: 'previousSeverity',sortable: false},
      trendIndication: {text: i18n.t('TrendIndication'), value: 'trendIndication',sortable: false },
